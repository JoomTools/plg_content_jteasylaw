 ...
 * @since  1.0.0
 */
class PlgContentJteasylawInstallerScript
{
	/**
	...
	public function preflight($action, $installer)
	{
		...
		{
			$app->enqueueMessage(JText::_('PLG_CONTENT_JTEASYLAW_MINPHPVERSION'), 'error');
		...
		{
			$app->enqueueMessage(JText::_('PLG_CONTENT_JTEASYLAW_MINJVERSION'), 'error');
